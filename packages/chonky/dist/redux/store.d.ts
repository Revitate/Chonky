...
export declare const useChonkyStore: (chonkyInstanceId: string) => import("@reduxjs/toolkit").EnhancedStore<RootState, import("redux").AnyAction, import("@reduxjs/toolkit").MiddlewareArray<any>>;
/**
